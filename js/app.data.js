$(document).ready(function() {
	...
	var $noteMail = {
		...
		title: 'Alert email and SMS sent, good sentiment gaining traction, engage! <br><small class="text-muted">2 July 13</small>',
		link: 'mail.html'
	}
	var $noteCalendar = {
		icon: '<i class="icon-time icon-2x text-default"></i>',
		title: 'Over 50+ retweets in the last hour! - Twitter <br><small class="text-muted">10 July 13</small>',
		link: 'calendar.html'
	}
	var $noteTimeline = {
		icon: '<i class="icon-time icon-2x text-default"></i>',
		title: 'Question gaining traction 5+ likes in the last 30 minutes! - facebook <br><small class="text-muted">1 minute ago</small>',
		link: 'timeline.html'
	}
